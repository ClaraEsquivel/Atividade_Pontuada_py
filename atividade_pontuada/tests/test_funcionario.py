...
def funcionario_valido():
    funcionario = Funcionario (123, "Clara", "(71)99111-2222", "clara@gmail.com", 
            ...
            Sexo.FEMININO.texto, EstadoCivil.SOLTEIRO.texto, "18/07/2003", "000.000.000-10", "20.000.000-0", "91164", Setor.SAUDE.texto, 1400)
    return funcionario
...
#     assert funcionario_valido.salario == 1400
...
#             Endereço ("Terezinha", "900", "Casa", "40711-000", "Salvador", UnidadeFederativa.BAHIA.texto), 
#             Sexo.FEMININO.texto, EstadoCivil.SOLTEIRO.texto, "18/07/2003", "", "20.000.000-0", "91164", 
#             Setor.SAUDE.texto, 1400)  
...
#           Funcionario (123, "Clara", "(71)99111-2222", "clara@gmail.com", 
#             Endereço ("Terezinha", "900", "Casa", "40711-000", "Salvador", UnidadeFederativa.BAHIA.texto), 
#             Sexo.FEMININO.texto, EstadoCivil.SOLTEIRO.texto, "18/07/2003", "000.000.000-10", "", "91164", 
#             Setor.SAUDE.texto, 1400)  
          
# def test_funcionario_matricula_vazio_mensagem_erro(funcionario_valido):
#     with pytest.raises(ValueError, match= "A matricula não pode ser vazia, você precisa informar a matrícula!"):
#           Funcionario (123, "Clara", "(71)99111-2222", "clara@gmail.com", 
#             Endereço ("Terezinha", "900", "Casa", "40711-000", "Salvador", UnidadeFederativa.BAHIA.texto), 
#             Sexo.FEMININO.texto, EstadoCivil.SOLTEIRO.texto, "18/07/2003", "000.000.000-10", "20.000.000-0", "", 
#             Setor.SAUDE.texto, 1400)  
          
# def test_funcionario_salario_negativo_mensagem_erro(funcionario_valido):
